...
const footerLinks = {
  courses: [
    { name: 'Web Development', href: '/courses?category=Development' },
    { name: 'Data Science', href: '/courses?category=Data%20Science' },
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <p className="text-xs text-gray-400 mb-3">
                Get the latest courses and platform updates.
              </p>
              <div className="flex">
                <input
                  type="email"
